...
function specificContents(event) {
  ...
  eachmovie_div_title.innerText = eachmovie.innerText.replace("상세정보", "");
  eachmovie_title = eachmovie_div_title.innerText.substring(
    0,
    eachmovie_div_title.innerText.indexOf("(")
  );
