...
if (window.navigator && window.navigator.msSaveOrOpenBlob) {
  var blob = new Blob([decodeURIComponent(csvContent)], {
  ...
  // HTML5 Blob
  var blob = new Blob([csvContent], { type: "text/csv;charset=utf8" });
  ...
  // Data URI
  var csvData =
    "data:application/csv;charset=utf-8," + encodeURIComponent(csvContent);
  var blob = new Blob([csvContent], { type: "text/csv;charset=utf8" });
  var csvUrl = URL.createObjectURL(blob);
  var a = document.createElement("a");
  a.setAttribute("style", "display:none");
